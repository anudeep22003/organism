...
# Instructions
- follow commit best practices, use feat(auth) or feat(backend) or at the least feat/refactor/chore prefix. 
- only commit what you have changed, do not commit unrelated files. 
- do not force something to commit if gitignore is set on it
